# Nithya Mart - E-commerce HTML Template
...
* **Structured Layout:** Centered design with horizontal dividers for clear content separation.
...
├── products.html             # General product overview
├── mensfashions.html         # Men's apparel section
├── womensfashions.html       # Women's apparel section
├── childrensfashions.html    # Kids' apparel section
├── electronics.html          # Electronics and gadgets section
└── Pictures/                 # Directory for assets/images
